...
import PhotoStanok from '@/assets/lazerStanok.png'
import Photo1 from '@/assets/Technology/Inner/posterVideo.png'
import MainPhoto from '@/assets/Technology/Inner/mainPhoto.png'
import { useParams } from 'react-router-dom'
import { useRef, useState } from 'react'
import testVidoe from '@/assets/demoZal/testVideo.mp4'
  ...
  return (
    <PageContainer>
      <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-8 mt-14 font-[Manrope]">
        ...
        <section className="mx-auto w-full font-[Manrope]">
          ...
          <div className="mb-24">
            ...
            <div className="relative max-w-4xl mx-auto rounded-lg overflow-hidden aspect-video">
              <video
                ...
                controls={playing}
              >
                <source src={testVidoe} type="video/mp4" />
              </video>
              {!playing && (
                <button
                  onClick={handlePlay}
