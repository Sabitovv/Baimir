...
const ProductionPage = () => {
  ...
  const platformLogos: ProductionImageItem[] = Array.from(
    { length: 6 },
    (_, i) => ({
  ...
  const [activePlatformLogo, setActivePlatformLogo] =
    useState<ProductionImageItem | null>(null);
  const productionContactRef = useRef<HTMLElement | null>(null);
  const activeImage = productionImages[activeImageIndex] ?? productionImages[0];
  ...
  return (
    <PageContainer>
      <div className="grid grid-cols-1 gap-6 lg:gap-10 mt-6 sm:mt-8 md:mt-12">
        ...
        */}
        ...
        <main className="w-full min-w-0">
          <ScrollReveal>
            <section>
              <h1 className="font-rubik text-3xl sm:text-4xl lg:text-5xl font-semibold uppercase text-[#FF4610] leading-tight">
                {t("production.title")}
              </h1>
              <h3 className="text-lg sm:text-xl lg:text-2xl mt-2 font-bold font-rubik text-gray-800">
          ...
          <section className="mt-20 sm:mt-24 mb-16 sm:mb-20 px-2 sm:px-0">
            <ScrollReveal>
              <h2 className="font-rubik text-2xl sm:text-3xl lg:text-4xl font-semibold text-[#FF4610] uppercase mb-8 sm:mb-10 text-center sm:text-left">
      ...
      <section className="mt-20 sm:mt-28 border-t border-gray-200 pt-16 sm:pt-20">
        <ScrollReveal>
          <h2 className="font-rubik text-3xl sm:text-4xl lg:text-5xl font-bold uppercase text-[#FF4610] mb-4 sm:mb-6 text-center lg:text-left">
          ...
          {platformLogos.map((logo, i) => (
            <StaggerItem key={i} className="flex flex-col group">
              ...
              <p className="font-medium text-gray-800 text-sm">
                {t("production.platformCard.type")}
              </p>
              <p className="font-light text-xs sm:text-sm text-gray-500 mt-1 mb-6 sm:mb-8">
                {t("production.platformCard.region")}
              </p>
            </StaggerItem>
          ))}
        </StaggerContainer>
      ...
      <ScrollReveal y={40} className="my-20 sm:my-28 px-4">
        <section ref={productionContactRef}>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-rubik font-semibold mb-8 sm:mb-12 text-center uppercase text-gray-900">
