        ...
        */}
        ...
        <main className="w-full min-w-0 relative">
          <ScrollReveal>
            <section className="relative overflow-hidden rounded-2xl border border-[#FF4610]/25 bg-gradient-to-br from-[#FFF2EE] via-[#ffffff] to-[#f3f6fa] p-5 sm:p-8 lg:p-10 grid grid-cols-1 xl:grid-cols-[1.2fr_1fr] gap-6 lg:gap-10 items-center">
              ...
              >
                ...
                <motion.h1
                  className="mt-3 font-rubik text-3xl sm:text-4xl lg:text-5xl font-semibold uppercase text-[#FF4610] leading-tight"
          ...
          <section className="mt-12 sm:mt-16 lg:mt-20">
            <ScrollReveal>
              <h2 className="font-rubik text-2xl sm:text-3xl lg:text-4xl font-semibold uppercase text-gray-900">
                {t('about.stats.title')}
              </h2>
            </ScrollReveal>
            ...
            <StaggerContainer className="mt-6 grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {stats.map((item) => (
                <StaggerItem key={item.label} className="relative overflow-hidden bg-white border border-gray-200 rounded-xl p-5 sm:p-6 shadow-[0_18px_30px_-26px_rgba(0,0,0,0.55)] hover:-translate-y-0.5 transition-transform">
                  ...
                  <p className="font-rubik text-3xl sm:text-4xl text-[#FF4610]">{item.value}</p>
          ...
          <section className="mt-12 sm:mt-16 lg:mt-20">
            <ScrollReveal>
              <h2 className="font-rubik text-2xl sm:text-3xl lg:text-4xl font-semibold uppercase text-[#FF4610]">
            ...
            <StaggerContainer className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              {advantages.map((item, index) => (
                ...
                >
                  <h3 className="font-rubik text-xl sm:text-2xl uppercase">{item.title}</h3>
            ...
            <section className="mt-12 sm:mt-16 lg:mt-20">
              <StaggerContainer className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                {companyInfoSections.map((section) => (
                  ...
                  >
                    <h3 className="font-rubik text-xl sm:text-2xl uppercase text-gray-900">
          ...
          <ScrollReveal className="mt-12 sm:mt-16 lg:mt-20 relative overflow-hidden bg-gradient-to-r from-[#171B25] via-[#1d2328] to-[#0f1418] border border-gray-700 rounded-2xl p-6 sm:p-8">
            ...
            <h2 className="relative z-10 font-rubik text-2xl sm:text-3xl uppercase text-white">
          ...
          <section className="mt-12 sm:mt-16 lg:mt-20 mb-16 sm:mb-20 grid grid-cols-1 xl:grid-cols-2 gap-6">
            <ScrollReveal id="work-schedule" className="bg-white border border-gray-200 rounded-xl p-6 sm:p-8 shadow-[0_18px_30px_-26px_rgba(0,0,0,0.55)]">
              <h2 className="font-rubik text-2xl sm:text-3xl uppercase text-gray-900">
            ...
            <ScrollReveal delay={0.15} className="relative overflow-hidden bg-[#171B25] text-white rounded-xl p-6 sm:p-8 border border-gray-700 shadow-[0_22px_35px_-24px_rgba(20,20,20,0.95)]">
              ...
              <h2 className="font-rubik text-2xl sm:text-3xl uppercase">{t('about.contacts.title')}</h2>
