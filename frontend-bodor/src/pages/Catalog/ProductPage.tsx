  ...
  switch (block.type) {
    case "heading": {
      ...
      return (
        <div
          key={block.id}
          className="space-y-1.5 sm:space-y-2 border-l-4 border-[#FF4610] pl-3 sm:pl-4 md:pl-5"
        >
          ...
          <table className="w-full min-w-[560px] text-xs sm:text-sm">
            ...
            <tbody>
              {body.map((row, rowIdx) => (
                <tr
                  key={rowIdx}
                  className="border-b border-gray-100 last:border-b-0 odd:bg-white even:bg-gray-50/55 hover:bg-[#FFF8EE] transition-colors"
                >
    ...
    case "list": {
      ...
      if (block.data.style === "number") {
        return (
          <ol
            key={block.id}
            className="list-decimal pl-5 sm:pl-6 space-y-1.5 sm:space-y-2 text-gray-700 marker:font-semibold marker:text-[#FF4610]"
          >
      ...
      return (
        <ul key={block.id} className="space-y-1.5 sm:space-y-2 text-gray-700">
          {block.data.items.map((item, idx) => (
            ...
            >
              <span className="text-[#FF4610] font-semibold">{marker}</span>
          ...
          <div>
            ...
            <p className="mt-3">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-[#FF4610] hover:underline"
              >
                {DELIVERY_DETAILS_URL}
              </a>
            </p>
              ...
              return (
                <p key={manager.id || managerPhone}>
                  <a
                    ...
                    className="font-semibold text-[#FF4610] hover:underline"
                  >
                    {managerPhone}
                  </a>{" "}
                  ...
                  {gallery.map((item, idx) => (
                    <button
                      ...
                      className={`
                        ...
                        ${
                          activeImage === idx
                            ? "border-[#FF4610] ring-4 ring-[#FF4610]/30 scale-105 shadow-lg"
            ...
            <div>
              <div className="flex flex-col sm:flex-row border-b gap-5 border-gray-100 pb-6">
                <div className="bg-gradient-to-br from-white to-gray-50 p-6 rounded-2xl border border-gray-200 shadow-lg w-full sm:w-2/3 transition-all duration-300 hover:shadow-xl">
                  <div className="mb-4">
                    ...
                    <div className="mb-5 flex flex-wrap items-center gap-2">
                      ...
                      {(product.newProduct ?? product.new) === true &&
                        product.inStock && (
                          <span className="inline-flex items-center rounded-full bg-[#FFF2EE] px-2.5 py-1 text-[11px] font-semibold text-[#E03A08]">
                            {t("commonCatalog.new")}
                          </span>
                        )}
                    </div>
                  ...
                  {items.find((item) => item.id === product.id) ? (
                    <div className="flex items-center justify-between bg-[#FF4610] rounded-xl overflow-hidden shadow-lg">
                      <button
                        type="button"
                        className="w-12 h-12 flex items-center justify-center text-white font-bold hover:bg-[#E03A08] transition-all duration-300"
                        onClick={() => {
                          const currentQty =
                            items.find((item) => item.id === product.id)
                              ?.quantity ?? 1;
                    ...
                    <button
                      ...
                      className={`w-full px-10 py-3 text-white font-bold uppercase transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-[1.02] bg-[#FF4610] hover:bg-[#E03A08]`}
                    >
                      {t("productPage.buy")}
                    </button>
                  )}
                  <button
                    ...
                    className={`mt-3 w-full px-5 py-3 border rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-2
                      ${
                        isInCompare
                          ? "border-[#FF4610] bg-[#FF4610]/10 text-[#E03A08]"
                          : "border-gray-300 text-gray-700 hover:border-[#FF4610] hover:text-[#E03A08]"
                      }`}
                  >
              ...
              <div className="mt-8 space-y-3">
                <div className="p-5 bg-gradient-to-br from-gray-50 to-white rounded-xl text-sm text-gray-600 border border-gray-200 shadow-sm">
                  <h5 className="text-[#FF4610] font-bold mb-2 text-xs uppercase">
                  ...
                  <div className="flex justify-between flex-wrap gap-2">
                    ...
                    <button
                      ...
                      className="font-bold hover:underline whitespace-nowrap text-[#FF4610] hover:text-[#E03A08] transition-colors"
                    >
                      {t("productPage.more")} →
                    </button>
                  </div>
                ...
                <div className="space-y-3 text-xs font-bold text-gray-500 uppercase mt-4">
                  <button
                    ...
                    className="flex w-full items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-all duration-300 text-[#FF4610]"
                  >
                    <span className="text-[#FF4610]">
                      <EditableImage
                    ...
                    <span className="hover:text-[#E03A08] transition-colors">
                      {t("productPage.delive")}
                    </span>
                  </button>
                  <button
          ...
          <div className="flex gap-8 overflow-x-auto">
            <button
              ...
              className={`pb-4 px-2 font-bold uppercase text-sm transition-all duration-300 whitespace-nowrap border-b-2 
                  ${activeTab === "desc" ? "border-[#FF4610] text-[#FF4610]" : "border-transparent text-gray-500 hover:text-gray-800 hover:border-gray-300"}`}
            >
            ...
            {hasSpecifications && (
              <button
                ...
                className={`pb-4 px-2 font-bold uppercase text-sm transition-all duration-300 whitespace-nowrap border-b-2 
                  ${activeTab === "specs" ? "border-[#FF4610] text-[#FF4610]" : "border-transparent text-gray-500 hover:text-gray-800 hover:border-gray-300"}`}
              >
            ...
            {hasAttachments && (
              <button
                ...
                className={`pb-4 px-2 font-bold uppercase text-sm transition-all duration-300 whitespace-nowrap border-b-2 
                  ${activeTab === "attachments" ? "border-[#FF4610] text-[#FF4610]" : "border-transparent text-gray-500 hover:text-gray-800 hover:border-gray-300"}`}
              >
            ...
            <button
              ...
              className={`pb-4 px-2 font-bold uppercase text-sm transition-all duration-300 whitespace-nowrap border-b-2 
                  ${activeTab === "order" ? "border-[#FF4610] text-[#FF4610]" : "border-transparent text-gray-500 hover:text-gray-800 hover:border-gray-300"}`}
            >
            ...
            >
              <div className="md:col-span-2">
                      ...
                      {product.variants.map((variant: ProductVariant) => (
                        ...
                        >
                          <div className="flex items-start justify-between gap-3 mb-3">
                            <div>
                              <div className="text-[#FF4610] font-bold leading-tight">
                                {variant.name}
                              </div>
                ...
                {otherInfoTabs.length > 0 && (
                  <div className="mt-10 rounded-2xl border border-[#FF4610]/20 bg-[#FFF8EE] p-5">
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      {otherInfoTabs.map((tab) => (
                        <button
                          ...
                          className="inline-flex items-center rounded-full border border-[#FF4610]/30 bg-white px-4 py-2 text-sm font-medium text-[#B32E05] transition-colors hover:bg-[#FF4610]/10"
                        >
                          {tab.label}
                        </button>
                      ))}
            ...
            <ul className="list-disc pl-5 space-y-2">
              {companyPhones.map((phone) => (
                <li key={phone}>
                  ...
                  <a
                    href={`tel:${normalizePhoneHref(phone)}`}
                    className="text-[#FF4610] font-bold"
                  >
                    {phone}
                  </a>
                </li>
                ...
                {effectiveManagers.map((manager) => {
                  ...
                  return (
                    ...
                    >
                      <a
                        href={`tel:${normalizePhoneHref(managerPhone)}`}
                        className="text-[#FF4610] font-semibold hover:underline"
                      >
                        {managerPhone}
                      </a>{" "}
                      - {managerName}
                      ...
                      >
                        <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                          <div className="min-w-0 flex items-start gap-3">
                            <div className="h-10 w-10 sm:h-12 sm:w-12 shrink-0 rounded-xl border border-[#FF4610]/30 bg-[#FFF2EE] flex items-center justify-center text-[#FF4610] font-extrabold text-[10px] sm:text-[11px] uppercase">
                              {extensionLabel}
                            </div>
                          ...
                          <div className="flex w-full sm:w-auto flex-col sm:flex-row items-stretch sm:items-center gap-2 md:shrink-0">
                            <button
                              ...
                              className="inline-flex w-full sm:w-auto items-center justify-center rounded-lg border border-[#FF4610] px-4 py-2.5 text-sm font-semibold text-[#FF4610] hover:bg-[#FFF2EE] transition-colors"
                            >
                            ...
                            {resolvedUrl && (
                              <a
                                ...
                                className="inline-flex w-full sm:w-auto items-center justify-center rounded-lg bg-[#FF4610] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#E03A08] transition-colors"
                              >
