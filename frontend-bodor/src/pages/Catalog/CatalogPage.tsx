  ...
  return (
    <PageContainer>
      <div className="mt-8 sm:mt-12 px-4 md:px-6 lg:px-0">
        <h1 className="font-rubik text-[22px] leading-tight sm:text-3xl md:text-4xl font-bold uppercase mb-6 sm:mb-10">
          {t("catalogPage.title")}
        </h1>
          ...
          <section className="mb-16 mt-8">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
              <div className="px-2 md:px-0 order-2 md:order-1">
                <h3 className="font-rubik text-2xl sm:text-4xl md:text-5xl font-bold uppercase mb-6 sm:mb-8 ml-2 sm:ml-4">
                  {t("catalogPage.bid")}
                </h3>
                <Contact />
              </div>
