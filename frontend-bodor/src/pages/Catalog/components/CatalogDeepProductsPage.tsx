    ...
    <section className="-mx-4 sm:mx-0 mb-5 sm:mb-6 md:mb-7 lg:mb-8 rounded-none sm:rounded-2xl border-x-0 sm:border-x border-y border-gray-100 bg-gradient-to-b from-white to-gray-50/60 p-2.5 sm:p-3.5 md:p-3 lg:p-4">
      <div className="mb-3 sm:mb-3.5 md:mb-3 flex items-center justify-between gap-2 sm:gap-3 px-1 sm:px-2">
        <div className="min-w-0">
          <h2 className="font-rubik text-sm sm:text-xl md:text-2xl lg:text-[28px] xl:text-3xl font-bold uppercase text-gray-900 truncate">
            {group.category.name}
          </h2>
          <div className="mt-1 h-[3px] w-12 sm:w-14 md:w-12 lg:w-16 rounded-full bg-[#FF4610]" />
        </div>

        <Link
          to={categoryLink}
          className="shrink-0 rounded-full border border-[#FFD6CB] bg-[#FFF2EE] w-8 h-8 sm:w-auto sm:h-auto px-0 sm:px-3 md:px-2.5 lg:px-4 py-0 sm:py-1.5 md:py-1.5 lg:py-2 flex items-center justify-center text-[10px] sm:text-xs md:text-[11px] lg:text-sm font-semibold uppercase tracking-wide text-[#E03A08] hover:bg-[#FFE3DB] transition-colors"
  ...
  return (
    <PageContainer>
      <div className="mt-8 sm:mt-10 md:mt-11 lg:mt-12 px-4 md:px-5 lg:px-0">
        ...
        <h1 className="font-rubik text-[22px] leading-tight sm:text-3xl md:text-[34px] lg:text-4xl font-bold uppercase mb-6 sm:mb-8 md:mb-9 lg:mb-10">
          {pageTitle}
        </h1>
