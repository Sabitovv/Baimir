...
const renderContentBlock = (block: BlogContentBlock, index: number) => {
  ...
  if (block.type === "heading") {
    ...
    if (level === 2) {
      return (
        <h2 key={key} className="font-rubik font-bold text-3xl mt-10 mb-5">
          {text}
        </h2>
      );
    }
    if (level === 3) {
      return (
        <h3 key={key} className="font-rubik font-bold text-2xl mt-8 mb-4">
          {text}
        </h3>
      );
    }
    return (
      <h4 key={key} className="font-rubik font-bold text-xl mt-6 mb-3">
        {text}
      </h4>
    );
  }
    ...
    return (
      ...
      >
        ...
        {(title || description) && (
          ...
          >
            {title && (
              <h3 className="font-rubik font-bold text-2xl text-gray-900 md:text-3xl">
                {title}
              </h3>
            )}
            {description && (
          ...
          return (
            ...
            >
              ...
              {(cardTitle || cardDescription) && (
                <div className="p-4">
                  {cardTitle && (
                    <h4 className="font-rubik font-bold text-lg text-gray-900 mb-2">
                      {cardTitle}
                    </h4>
                  )}
                  {cardDescription && (
    ...
    return (
      <PageContainer>
        <div className="py-16 text-center">
          <h2 className="text-2xl font-rubik font-bold mb-3">
      ...
      <div className="grid grid-cols-1 gap-8 mt-16">
        ...
        */}
        ...
        <article className="max-w-[900px] mb-16">
          <h1 className="font-rubik font-bold text-3xl md:text-4xl xl:text-5xl uppercase mb-5">
            {title}
          </h1>
