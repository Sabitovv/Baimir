...
const RepairService = () => {
  ...
  return (
    <section className="py-24 bg-[#F5F7F8]">
      <PageContainer>
        <ScrollReveal>
          <h1 className="font-rubik text-[#0E1621] text-4xl min-[650px]:text-5xl min-[900px]:text-6xl font-bold uppercase mb-4">
            {t('home.repair.title')}
          </h1>
        ...
        <ScrollReveal delay={0.15}>
          ...
          <div className="relative w-full rounded-xl overflow-hidden shadow-xl">
            ...
            <div className="block min-[650px]:hidden">
              ...
              <div className="bg-[#FF4610] px-6 py-10 text-[#171B25]">
                <h3 className="font-rubik text-2xl uppercase mb-6 font-bold">
              ...
              {/* Dark card – client */}
              <div className="bg-[#171B25] px-6 py-10 text-white">
                <h3 className="font-rubik text-2xl uppercase mb-6 font-bold">
            ...
            <div className="hidden min-[650px]:block relative min-h-[420px] bg-[#FF4610]">
              ...
              <div
                className="absolute top-0 bottom-0 left-1/2 w-[60%]
                           bg-[#171B25] -skew-x-[10deg] origin-left overflow-hidden z-10"
              >
              ...
              <div className="relative z-20 block min-[650px]:flex w-full h-full min-[650px]:justify-between">
                ...
                <div className="w-full min-[650px]:w-[40%] px-6 min-[650px]:px-12 py-8 min-[650px]:py-12 text-[#171B25] mt-6 min-[650px]:mt-10">
                  <h3 className="font-rubik text-3xl uppercase mb-6 font-bold">
                    {t('home.repair.engineer.title')}
                  </h3>
                ...
                <div className="w-full min-[650px]:flex-1 px-6 min-[650px]:px-10 min-[900px]:px-16 py-8 min-[650px]:py-12 text-white flex flex-col items-end text-end mt-6 min-[650px]:mt-10">
                  <div>
                    <h3 className="font-rubik text-2xl min-[1000px]:text-3xl uppercase mb-6 font-bold">
                      {t('home.repair.client.title')}
                    </h3>
