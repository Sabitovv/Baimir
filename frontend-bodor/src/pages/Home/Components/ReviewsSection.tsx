...
const ReviewsSection = ({ onOpenReviewModal }: ReviewsSectionProps) => {
  ...
  if (isLoading) {
    return (
      <div className="py-24 text-center text-[#4B5563]">
        {t("home.reviews.loading", { defaultValue: "Загрузка отзывов..." })}
      </div>
    );
  }
    ...
    <section className="py-16 md:py-20 xl:py-24 bg-[#F5F5F5] overflow-x-hidden">
      <PageContainer>
        <ScrollReveal>
          <h2
            className="
              font-rubik font-semibold text-center 
          ...
          <div className="relative">
            <button
              ...
              className="
                ...
                text-[#374151] hover:bg-[#171B25] hover:text-white hover:border-[#171B25]
                      ...
                      >
                        <div className="flex items-start gap-3">
                          {review.imageUrl ? (
                            ...
                            <div className="w-12 h-12 rounded-full bg-[#F59E0B] text-white flex items-center justify-center font-rubik text-xl">
                              {getInitial(review.authorName)}
                            </div>
                          )}

                          <div className="flex-1 min-w-0">
                            <h4 className="font-rubik font-semibold text-[17px] leading-tight text-[#111827] mb-1 truncate">
                              {review.authorName}
                            </h4>
                        ...
                        <div className="pt-3 border-t border-[#E5E7EB] flex items-center justify-between gap-3 text-[12px]">
                          ...
                          {profileLink && (
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="inline-flex items-center gap-1 text-[#F59E0B] hover:text-[#E03A08] font-semibold whitespace-nowrap"
                            >
            ...
            <div className="mt-5 flex items-center justify-center gap-3 md:hidden">
              <button
                ...
                disabled={!canNavigate}
                aria-label={t("commonCatalog.prev", { defaultValue: "Предыдущий" })}
                className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-[#6B7280] bg-white text-[#374151] transition hover:bg-[#171B25] hover:text-white hover:border-[#171B25] disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:bg-white disabled:hover:text-[#374151] disabled:hover:border-[#6B7280]"
              >
        ...
        <ScrollReveal className="flex justify-end">
          <button
            ...
            className="
              mt-8 md:mt-12
              bg-[#FF4610] hover:bg-[#E03A08]
              px-8 md:px-10 py-3 md:py-4
              font-bold uppercase tracking-widest
              transition
              text-xs md:text-sm
              hover:shadow-lg hover:shadow-[#DC0000]/20
              text-white
            "
          >
