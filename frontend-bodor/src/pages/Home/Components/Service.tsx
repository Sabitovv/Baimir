...
const Service = () => {
  ...
  const CheckCircleIconCustom = (props: SvgIconProps) => (
    <SvgIcon {...props} viewBox="0 0 24 24">
      ...
      <circle cx="12" cy="12" r="10" fill="#FF4610" />
      <path
    ...
    <section className="relative overflow-hidden py-12 md:py-20">
      ...
      <div className="relative z-10">
        <PageContainer>
          ...
          <ScrollReveal>
            <h1 className="font-rubik text-[32px] font-semibold uppercase leading-[1.06] text-white md:text-5xl xl:text-6xl">
            ...
            {services.map((key) => (
              <StaggerItem key={key}>
                <div className="flex items-center gap-3 rounded-lg bg-black/20 px-3 py-2.5 backdrop-blur-[1px] md:bg-transparent md:px-0 md:py-0">
                  ...
                  <p className="font-rubik text-[15px] font-bold leading-5 text-white md:text-xl">
                    {t(key)}
                  </p>
                </div>
              </StaggerItem>
