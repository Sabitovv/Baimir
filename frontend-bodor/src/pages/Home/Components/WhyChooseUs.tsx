    ...
    <section className="bg-[#F5F5F5] py-12 md:py-20">
      <PageContainer>
        <div className="px-1 md:px-0">
          ...
          <ScrollReveal>
            <h2 className="mb-6 font-rubik text-[32px] font-semibold uppercase leading-[1.06] text-[#171B25] md:mb-12 md:text-5xl xl:text-6xl">
              {t('home.why.title')}
            </h2>
          </ScrollReveal>
            ...
            {features.map((item, index) => (
              <StaggerItem key={index}>
                <div className="group flex h-full flex-col rounded-xl border border-[#ECECEC] bg-white p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md md:p-8">
                  ...
                  <h3 className="mb-2 font-rubik text-[15px] font-bold uppercase leading-5 md:text-xl">
                    {t(item.titleKey)}
                  </h3>
