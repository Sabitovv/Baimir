                ...
                {breadcrumbs.map((item, index) => {
                    ...
                    return (
                        <li key={index} className="flex min-w-0 shrink-0 items-center sm:shrink">
                            ...
                            {isLast ? (
                                <span
                                    className="max-w-[170px] truncate px-1 py-1 font-semibold text-[#238ECE] sm:max-w-none"
                                    title={item.name}
                                >
                                    {item.name}
                                </span>
                                ...
                                <Link
                                    to={toPath}
                                    className="max-w-[170px] truncate rounded px-1 py-1 transition-colors hover:text-[#066AAB] sm:max-w-none"
                                    title={item.name}
                                >
                                    {item.name}
                                </Link>
