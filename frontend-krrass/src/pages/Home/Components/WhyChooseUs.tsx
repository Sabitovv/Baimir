    ...
    <section className="bg-[#F5F5F5] py-12 md:py-20">
      <PageContainer>
        <div className="px-1 md:px-0">
          ...
          <ScrollReveal>
            <h2 className="mb-6 font-manrope text-[32px] font-semibold uppercase leading-[1.06] text-[#222222] md:mb-12 md:text-5xl xl:text-6xl">
              {t('home.why.title')}
            </h2>
          </ScrollReveal>
            ...
            {features.map((item, index) => (
              <StaggerItem key={index}>
                <div className="group flex h-full flex-col rounded-xl border border-[#ECECEC] bg-white p-5 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md md:p-8">
                  <div className="mb-3 text-[#238ECE]">
                    <EditableImage
                      imageKey={item.key}
