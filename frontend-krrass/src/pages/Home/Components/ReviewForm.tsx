...
const ReviewForm = ({ isModal = false, onSuccess }: ReviewFormProps) => {
  ...
  const title = (
    <h2 className={`
      font-manrope font-semibold uppercase text-[#222222]
      tracking-tight
  ...
  const inputClass = `
    ...
    focus:border-[#222222]
    focus:ring-2 focus:ring-[#222222]/15
    outline-none
              ...
              <div className="pt-2 flex justify-center">
                <button
                  ...
                  className="
                    ...
                    disabled:hover:bg-[#238ECE]
                    focus:ring-2 focus:ring-[#238ECE]/30 focus:ring-offset-2
                    outline-none
                  "
                >
                  {isLoading ? (
