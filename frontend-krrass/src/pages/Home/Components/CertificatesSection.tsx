  ...
  return (
    <section className="py-16 md:py-20 bg-white overflow-x-hidden">
      <PageContainer>
        ...
        <ScrollReveal>
          <h2 className="font-manrope font-bold uppercase text-[#222222] text-3xl md:text-4xl xl:text-5xl mb-10">
        ...
        <ScrollReveal delay={0.15}>
          <div className="relative">
            ...
            <Swiper
              ...
              className="[&_.swiper-pagination]:!relative [&_.swiper-pagination]:!mt-4 [&_.swiper-pagination-bullet]:bg-[#9CA3AF] [&_.swiper-pagination-bullet-active]:bg-[#238ECE]"
              breakpoints={{
        ...
        <div className="absolute inset-0 p-3 md:p-6 flex items-center justify-center">
          ...
          >
            <button
              ...
              onClick={() => setActiveCertificate(null)}
              className="absolute right-2 top-2 z-10 w-8 h-7 md:w-10 md:h-10 rounded-full bg-white text-[#222222] border border-[#E5E7EB] hover:bg-[#F9FAFB] transition"
            >
              x
            </button>
