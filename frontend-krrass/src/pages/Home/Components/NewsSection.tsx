      ...
      <PageContainer>
        ...
        <ScrollReveal>
          <div className='flex items-end justify-between'>
            <h2 className="font-manrope font-bold uppercase text-[#222222]
                text-3xl md:text-4xl xl:text-5xl mb-10">
              {t('home.news.title')}
            </h2>
            <Link to="/Blog" className='font-manrope font-semibold uppercase text-[#222222] text-sm md:text-md xl:text-xl mb-10 hover:text-[#066AAB] hover:underline'>
        ...
        {isLoading && (
          <div className="flex justify-center py-12">
            <div className="animate-spin rounded-full h-10 w-10 border-b-2 border-[#238ECE]"></div>
          </div>
        )}
                  ...
                  <Link to={`/blog/${post.slug}`} className="block group h-full">
                    <article className="bg-white shadow-md hover:shadow-xl border border-gray-200 transition-all duration-300 flex flex-col cursor-pointer h-full rounded-lg overflow-hidden">
                      ...
                      <div className="p-4 flex flex-col flex-grow">
                        <h3 className="font-bold text-sm leading-snug line-clamp-2 mb-2 group-hover:text-[#238ECE] transition-colors duration-300">
                          {title}
                        </h3>
                        ...
                        <div className="mt-auto pt-3 border-t border-gray-100">
                          <div className="flex items-center justify-between text-[11px] text-gray-500">
                            <div className="flex items-center gap-1">
                              <PersonOutlineRoundedIcon sx={{ fontSize: 14, color: '#238ECE' }} />
