...
const ComparePage = () => {
  ...
  const handleBack = () => {
    ...
    navigate("/catalog/listogibochnye-stanki");
  };
        ...
        <section className="mx-auto max-w-7xl px-4 py-8 sm:py-12">
          ...
          <div className="mt-6 rounded-2xl border border-gray-200 bg-white p-5 text-center shadow-sm sm:mt-8 sm:p-8">
            ...
            <Link
              ...
              className="mt-5 inline-flex rounded-xl bg-[#238ECE] px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#066AAB] sm:px-5 sm:py-3 sm:text-base"
            >
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              type="button"
              onClick={handleBack}
              className="inline-flex items-center gap-1.5 rounded-xl bg-[#238ECE] px-3 py-2 text-xs font-semibold text-white shadow-sm transition-colors hover:bg-[#066AAB] sm:gap-2 sm:px-4 sm:text-sm"
            >
            ...
            <button
              ...
              className="rounded-xl border border-gray-300 px-3 py-2 text-xs font-semibold text-gray-700 transition-colors hover:border-[#238ECE] hover:text-[#066AAB] sm:px-4 sm:text-sm"
            >
              {t("compare.clear")}
            </button>
          </div>
                  ...
                  return (
                    <button
                      ...
                      className={`flex shrink-0 items-center gap-1.5 rounded-xl px-3 py-2 text-xs font-semibold whitespace-nowrap transition sm:gap-2 sm:px-4 sm:text-sm ${
                        isActive
                          ? "bg-[#238ECE] text-white"
                          : "bg-gray-100 text-gray-700 hover:bg-[#EAF3FA] hover:text-[#066AAB]"
                      }`}
                    >
            ...
            <section className="mt-5 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm sm:mt-6 sm:p-6">
              <div className="flex flex-wrap items-center justify-between gap-3 border-b border-gray-200 pb-3 sm:pb-4">
                ...
                <button
                  ...
                  className="hidden rounded-lg border border-gray-300 px-3 py-1.5 text-xs font-semibold text-gray-700 transition-colors hover:border-[#238ECE] hover:text-[#066AAB] sm:inline-flex"
                >
                  {t("compare.clear")}
                </button>
              </div>
              ...
              <div className="mt-4 grid grid-cols-2 gap-1 rounded-xl bg-gray-100 p-1 sm:mt-6 sm:inline-flex sm:items-center sm:gap-2 sm:bg-transparent sm:p-0">
                <button
                  ...
                  className={`w-full rounded-lg px-3 py-2 text-xs font-semibold transition sm:w-auto sm:px-4 sm:text-sm ${
                    !showOnlyDifferences
                      ? "bg-[#238ECE] text-white"
                      : "bg-white text-gray-700 hover:text-[#066AAB] sm:border sm:border-gray-300 sm:hover:border-[#238ECE]"
                  }`}
                >
              ...
              <div className="mt-5 hidden grid-cols-1 gap-4 sm:grid-cols-2 lg:grid lg:grid-cols-4">
                {activeGroup.products.map((product) => (
                  ...
                  >
                    ...
                    <p className="mt-1 text-sm font-bold text-[#238ECE]">
                      {formatPrice(product.price)}
                    </p>
                    <button
                      type="button"
                      onClick={() => dispatch(removeFromCompare(product.id))}
                      className="mt-3 rounded-lg border border-gray-300 px-3 py-1.5 text-xs font-semibold text-gray-700 transition-colors hover:border-[#238ECE] hover:text-[#066AAB]"
                    >
                      {t("compare.remove")}
                    </button>
                  </article>
                        ...
                        {activeGroup.products.map((product) => (
                          ...
                          >
                            ...
                            <article className="rounded-xl border border-gray-200 bg-white p-2 shadow-sm lg:hidden">
                              ...
                              <p className="mt-1 text-xs font-bold text-[#238ECE]">
                                {formatPrice(product.price)}
                              </p>
                              <button
                                type="button"
                                ...
                                className="mt-2 rounded-md border border-gray-300 px-2 py-1 text-[10px] font-semibold text-gray-700 transition-colors hover:border-[#238ECE] hover:text-[#066AAB] sm:text-xs"
                              >
                                {t("compare.remove")}
                              </button>
                            </article>
